#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""سكريبت تحديث monitor_v10.py من GitHub (للمستودعات الخاصة)"""
...
FILE_PATH = "monitor_v10.py"
TARGET_FILE = "monitor_v10.py"

API_URL = f"https://api.github.com/repos/{REPO}/contents/{FILE_PATH}"

def download_v10():
    print("=" * 60)
    print("📥 تحديث monitor_v10.py من GitHub")
    print("=" * 60)
    print()
