...
# [rule-v4.4.15 — 2026-09-11] [REQ-CATCH-LEX] أمر المُشغّل: إضافة عائلة
# «ملخص» لمفعولات التنفيذ الأكاديمية (HOMEWORK_NOUNS) — طلبات «أحد
# يسوي ملخصات» كانت تسقط REJECT other. القاعدة v4.4.11 الحية فقط
# بلا أي تغيير آخر (الأرقام 12-14 مستهلَكة في تاريخ main لفرع مرفوض).
RULE_ENGINE_VERSION = "rule-v4.4.15"
...
HOMEWORK_NOUNS = (
    ...
    # [REQ-CATCH-v4.4.15] أمر المُشغّل (2026-09-11): «ابيه كمان يسحب
    # نفس هذه الطلبات: بنات تعرفون احد يسوي ملخصات للمواد النظريه؟»
    # — «ملخص/ملخصات» كانت فقط في RESOURCE_NOUNS (ملكية جاهزة) فطلب
    # التنفيذ «أحد يسوي ملخصات» بلا مفعول آخر سقط REJECT other.
    # الآن: صنع/تسوي ملخصات = مفعول أكاديمي (يلخص فعل تنفيذ موجود
    # سلفًا). «مين عنده ملخصات؟» بلا فعل تنفيذ تبقى REJECT resource.
    'ملخص', 'ملخصات', 'تلخيص', 'لخص',
)
