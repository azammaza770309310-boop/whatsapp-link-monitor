...
ACCEPT_CASES = [
    ...
    # ---- [ADMIN-NOTICE-v4.4.3] حماية الطلبات رغم وجود أدوات النفي ----
    ("مافيه احد يقدر يحل كويزات التفاضل؟", "homework_execution_request"),
    ("ابي احد يحل لي الواجب بس ممنوع الغش", "homework_execution_request"),
    # ---- [REQ-ACADEMIC-v4.4.5] هروب ذيل نعم/لا + التفويض المجرد القوي ----
    # «فيه احد يسوي سكليف ولا لا؟» = سؤال-مجهول حقيقي رغم ذيل نعم/لا.
    ("فيه احد يسوي سكليف ولا لا؟", "homework_execution_request"),
    # «رقم احد» = تفويض قوي بلا مفعول أكاديمي (طلب الوصول لمنفّذ).
    ("مين عنده رقم احد مضمون يسويها؟", "student_service_execution_request"),
]

REJECT_CASES = [
    # ---- [GENIUS-PLAN-v4.4.2] بلاغ الإنتاج 2026-09-05 «الفلتر زبالة» ----
    # (أ) إعادة توجيه مزوّد: «الي يبغى رقم مختص… يرسل لي خاص» — الرغبة
    #     محرفة لطرف ثالث + إحالة تواصل = إعلان لا طلب.
    "الي يبغى رقم مختص شاطر يحل المواد ويسوي بحوثات وسكاليف يرسل لي خاص",
    "الي يحتاج مختص يسوي بحوثات يرسل لي خاص",
    "الي يبي مختص يخلص التكاليف راسلني",
    "لمن يود مشاركة على المايك يكتب رقم 𝟭𝟬𝟬",
    # (ب) تعليمات حدث/سرد شخصي: لا رغبة ولا استفهام من المُرسل
    "لمن يود المشاركة على المايك وطرح ماعنده من اسئلة حول هذه الدعوة المباركة 1):يكتب رقم 𝟭𝟬𝟬 2): يطلب التحدث في المكالمة الصوتية",
    "ماعرف قاهرني ومابي ابحث وافتش احس بنهار او اكتشف شي لان حياتي مره حلوووه بس خلاص مافيه شي يرقع اللي يسويه",
    ...
    # ---- [ADMIN-NOTICE-v4.4.3] بلاغ الإنتاج 02:59: تحذير إداري اجتاز
    # الشلال كطلب (لا/ممنوع تُقرأ كإشارة استفهام + «يكتب رقم» تفويض).
    # النفي/المنع = قاعدة إدارية، ليس طلبًا.
    "القروبات ف البلاك بورد دوروها ممنوعه هنا لان هنا بيدخل معكم اشخاص مو دارسين الماده ويبدون ينصبون عليكم ويدخلون خاص عليكم بالواتس وكثير امور .. ف كرماً لا احد يطلب قروب هنا او يكتب رقم الشعب",
    "ممنوع نشر ارقام الشعب بالقروب",
    "كرما لا احد يرسل رقم شعبه هنا",
    "تنبيه: يمنع طلب القروبات بالبلاك بورد هنا",
    # ---- [REQ-ACADEMIC-v4.4.5] بلاغ الإنتاج 2026-09-05 (~06:00) «الفلتر
    # زبالة»: قبولان خاطئان حيّان — (أ) رسالة زوجية حميمة 0.93: «من»
    # طالب + «لي» تفويض + «يخلص» تنفيذ بلا أي محتوى أكاديمي. (ب) سؤال
    # معلوماتي عن عادة دكتور 0.96: يسوي+اختبار+اللي. الجذران: ذيل نعم/لا
    # = استفهام تأكيد لا طلب؛ والتفويض المجرد الضعيف (لي/معي) حروف جر.
    "بنات انا متزوجه ومشكلتي مع العلاقه بالفراش \nمن تزوجت صار لي 3 سنوات ماحسيت بمتعة العلاقه معه هو يخلص سريع \n\nفيه مشكله ولا كذا كل الرجال ؟",
    "اللي اعرفه ايهاب يسوي اختبار بعد كل نموذج ولا مافيه ؟",
    "فيه مشكله ولا كذا كل الرجال ؟",
    "اللي عندهم معلومه عن دفعات السكن ولا مافيه ؟",
]
