...
class RateLimiter:
    ...
    OP_LIMITS = {
        'join':              {'max': 30,  'window': 3600, 'min_delay': 60},  # 30/ساعة, 1 دقيقة بين كل واحد
        'import_invite':     {'max': 30,  'window': 3600, 'min_delay': 60},
        'join_channel':      {'max': 30,  'window': 3600, 'min_delay': 60},
