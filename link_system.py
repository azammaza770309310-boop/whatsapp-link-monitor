...
class RateLimiter:
    ...
    # حدود كل نوع عملية (conservative post-FloodWait)
    OP_LIMITS = {
        'join':              {'max': 1,   'window': 3600, 'min_delay': 3600},  # 1/ساعة, 1h بين كل واحد (conservative)
        'import_invite':     {'max': 1,   'window': 3600, 'min_delay': 3600},
        'join_channel':      {'max': 1,   'window': 3600, 'min_delay': 3600},
