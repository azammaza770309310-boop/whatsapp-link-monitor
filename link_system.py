...
class RateLimiter:
    ...
    OP_LIMITS = {
        'join':              {'max': 50,  'window': 3600, 'min_delay': 30},  # 50/ساعة, 30 ثانية بين كل واحد
        'import_invite':     {'max': 50,  'window': 3600, 'min_delay': 30},
        'join_channel':      {'max': 50,  'window': 3600, 'min_delay': 30},
